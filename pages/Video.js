...
import {doc,snapShot,onSnapshot,query, addDoc, collection} from "firebase/firestore";
...
import {CategoryItems} from "../static.js/data";
import { Link } from 'react-router-dom';
import RecommantVideo from '../components/RecommantVideo';
...
const Video = () => {
  ...
  return (
    ...
    <div className="left flex-1">
          ...
          <div className='flex'>
            <div className='flex items-center'>
              ...
              <div className='flex pl-28'>
                <div className='flex bg-yt-black items-center rounded-2xl mx-1 hover:bg-yt-light-1'>
              ...
              <div className='flex bg-yt-black items-center rounded-2xl h-10 mx-1 cursor-pointer hover:bg-yt-light-1'>
      ...
      <div className='max-w-4xl bg-yt-light-black mt-4 rounded-2xl pl-3 text-sm text-yt-white'>
        <div className='flex'>
      ...
      <div className='text-yt-white mt-5'>
        <div className='flex items-center'>
          ...
          <div className='flex items-center mx-10'>
            <MdOutlineSort size={30} className='mx-3'></MdOutlineSort>
            <h5>
              Sort by
            </h5>
          </div>
