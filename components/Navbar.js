...
const Navbar = () => {
  ...
  return (
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-content fixed w-full z-10">
    ...
    <div className='h-10 flex flex-row items-center m-auto'>
    <div className="w-[593px] bg-yt-black flex border border-yt-light-black items-center rounded-3xl h-10">
          ...
          />
      <button className='w-16 h-10 bg-yt-light-black px-1 py-0.5 rounded-r-3xl  border-1-2 border-yt-light-black'>
        <HiMagnifyingGlass
        size={22}
    ...
    <div className='flex  items-center justify-center'>
      <div className='flex flex-row items-center'>
        ...
        <div className='mx-3 items-center cursor-pointer'>
          {
            !user ? (
              <button className='bg-yt-red py-1 px-4 text-yt-white rounded-md' onClick={handlelogin}
              >Sign In</button>
            ):(
              <img 
              src={user.photoURL}
